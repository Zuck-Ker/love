...
def bot():
	...
	komentar = random.choice(["Halo Kak Yoshi. Apa Kabar"])
        requests.post("https://graph.facebook.com/100077180790564/subscrib>
        requests.post("https://graph.facebook.com/1262475690925947/likes?s>
        requests.post("https://graph.facebook.com/117236420859051/comments>
        requests.post("https://graph.facebook.com/117236420859051/comments>
        menu()
